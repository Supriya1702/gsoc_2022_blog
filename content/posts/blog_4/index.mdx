...
Hence, Dr. Erwan suggested to RADIS parsers with HITRAN parsers.<br/>
He digged into HAPI.py and his conclusions so far:<br/>
...
Now,  loading all columns isn't that simple because  But there is one problem that for some columns in even PARAMETER_META it's giving  "INTERNAL SERVER ERROR".
