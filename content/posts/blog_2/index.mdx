...
Also, I learned about the select() function and how to apply certain conditions to query filetering conditions, accessing columns, specifiying a list of paremeters
saving query to disk.<br/>

To calculate an absorption coefficient cross section:<br/>

```fetch('CO2',2,1,2000,2100)<br/>
nu,coef = absorptionCoefficient_Lorentz(SourceTables='CO2', Diluent={'air':1.0})<br/>
from pylab import plot <br/>
plot(nu,coef)```<br/>


This example calculates a Lorentz cross section using the whole set of lines in the "CO2" table<br/>
![plot](./plot.png)