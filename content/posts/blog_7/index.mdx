...
This PR https://github.com/radis/radis/pull/495 <br/>
  ...
  4) Added required functions to adjust diluent parameter<br/>
  5) Added test functions as well<br/>

The lineshapes with different diluents were different like displayed in the plot below <br/>
![Diluent](./Diluent.png)
