...
Now coming to work, after researching more into the hapi codebase I found that rather than using "PARAMETER_META" to load indiviudal columns I could just pass groups of columns(these groups are already mentioned in Hapi) in "ParameterGroup" of fetch().<br/>
